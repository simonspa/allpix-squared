...
public:
   ...
   */
  MCTrack(ROOT::Math::XYZPoint start_point, ROOT::Math::XYZPoint end_point,
          std::string g4_volume, std::string g4_prod_process_name,
          int g4_prod_process_type, int particle_id, double initial_kin_E,
          double final_kin_E, double initial_tot_E, double final_tot_E);
   ...
   * @warning No \ref MissingReferenceException is thrown, because a track
