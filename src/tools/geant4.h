 ...
 * @brief Enable support to convert string directly to Geant4 3D vector while
 * fetching configuration parameter
 */
inline G4ThreeVector from_string_impl(std::string str,
...
/**
 * @ingroup StringConversions
 * @brief Enable support to convert Geant4 3D vector to string for storage in
 * the configuration
 */
...
/**
 * @ingroup StringConversions
 * @brief Enable support to convert string directly to Geant4 2D vector for
 * fetching configuration parameter
 */
...
/**
 * @ingroup StringConversions
 * @brief Enable support to convert Geant4 2D vector to string for storage in
 * the configuration
 */
 ...
 */
template <typename T>
G4ThreeVector toG4Vector(const ROOT::Math::DisplacementVector3D<T> &vector) {
 ...
 */
template <typename T>
G4ThreeVector toG4Vector(const ROOT::Math::PositionVector3D<T> &vector) {
  return G4ThreeVector(vector.x(), vector.y(), vector.z());
}
} // namespace allpix
